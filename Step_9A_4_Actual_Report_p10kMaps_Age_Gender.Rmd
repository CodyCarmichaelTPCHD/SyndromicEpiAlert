---
title: "EpiAlert v2.0 - Per 10k Age and Gender based Map Report"
...
** For the love of all that is holy, check suppression as there is none here!! **
...
asis_output("# per10k Map of Visits, by Age, Race/Ethnicity, and Gender.  \n") # Header that is only shown if print_option == TRUE
 }
```
